...
[.api-source]
link:https://github.com/outskirtslabs/client-ip/blob/v0.1.x/src/ol/client_ip/core.clj#L43-L58[source,window=_blank]
...
[.api-source]
link:https://github.com/outskirtslabs/client-ip/blob/v0.1.x/src/ol/client_ip/core.clj#L60-L121[source,window=_blank]
